...
function About() {
    return (
        <div id="about">
            ...
            <p>This tool helps wholesale grocery warehouse management by enabling them to upload employees with their own specific productivity metrics and updates the summary to reflect potential gaps. </p>
